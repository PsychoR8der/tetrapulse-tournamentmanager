<%@ Control Language="C#" AutoEventWireup="false" Inherits="TetraPulse.Modules.TournamentManager.Settings" Codebehind="Settings.ascx.cs" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<table cellspacing="0" cellpadding="2" border="0" summary="TournamentManager Settings Design Table">
    <tr>
